  ...
  <main class="app-content">
     ...
     <div class="row">
        <div class="col-md-12">
           <div class="tile">
              <div class="tile-body">
                 <form role="form" method="POST" action="<?php echo e(route('admin.UpdateSmsSetting')); ?>" >
                    <?php echo e(csrf_field()); ?>

                    <div class="form-body">
                       <div class="form-group">
                          <label for="">SMS API</label>
                          <input type="text" name="smsApi" id="smsapi" class="form-control" value="<?php echo e($gs->sms_api); ?>">
