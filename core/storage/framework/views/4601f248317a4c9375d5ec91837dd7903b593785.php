<?php $__env->startSection('title', 'Product Upload'); ?>

<?php $__env->startSection('headertxt', 'Product Upload'); ?>
                                              ...
                                              <div class="form-check form-check-inline">
                                                <select class="input-field" name="flash_interval">
                                                  <?php $__currentLoopData = $flashints; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $flashint): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($flashint->id); ?>"><?php echo e($flashint->start_time . " - " . $flashint->end_time); ?></option>
                                                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </select>
                                              </div>
                                            </div>
...
<?php $__env->startSection('preimgscripts'); ?>
  ...
  $(document).ready(function() {
    ...
    function upload(e) {
      ...
      $.ajax({
        url: '<?php echo e(route('vendor.product.store')); ?>',
        type: 'POST',
        data: fd,
        contentType: false,
        processData: false,
