...
<?php if(!empty(Request::route('category')) && !empty(request()->input('term'))): ?>
    <?php $__env->startSection('headertxt'); ?>
    Search on <?php echo e(\App\Category::find(Request::route('category'))->name); ?> <?php if(!empty(Request::route('subcategory'))): ?> <i class="fa fa-arrow-right mx-1"></i> <?php echo e(\App\Subcategory::find(Request::route('subcategory'))->name); ?> <?php endif; ?>
    <?php $__env->stopSection(); ?>
<?php elseif(!empty(Request::route('category')) && empty(request()->input('term'))): ?>
    <?php $__env->startSection('headertxt'); ?>
    <?php echo e(\App\Category::find(Request::route('category'))->name); ?> <?php if(!empty(Request::route('subcategory'))): ?> <i class="fa fa-arrow-right mx-1"></i> <?php echo e(\App\Subcategory::find(Request::route('subcategory'))->name); ?> <?php endif; ?>
    <?php $__env->stopSection(); ?>
<?php elseif(empty(Request::route('category')) && !empty(request()->input('term'))): ?>  
    <?php $__env->startSection('headertxt'); ?>
    Search Over Shop
          ...
          <div class="row">
              <div class="col-lg-3">
                  <div class="category-sidebar"><!-- category sidebar -->
                      <div class="category-filter-widget"><!-- category-filter-widget -->
                        <div class="sidebar-header">
                          ...
                          <ul class="cat-list">
                            <li>
                              <a href="<?php echo e(url('/').'/shop'); ?>" class="<?php echo e(!Request::route('category') ? 'base-txt' : ''); ?>">All Categories </a>
                            </li>
                              ...
                              <li>
                                ...
                                <ul class="subcategories <?php echo e(Request::route('category') == $category->id ? 'open' : ''); ?>">
                                  <?php $__currentLoopData = $category->subcategories()->where('status', 1)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $subcategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li><a href="<?php echo e(route('user.search', [$category->id, $subcategory->id])); ?>" class="<?php echo e(Request::route('subcategory') == $subcategory->id ? 'base-txt' : ''); ?>"><?php echo e($subcategory->name); ?></a></li>
                  ...
                  <div class="category-compare margin-bottom-30">
                     ...
                     <div class="">
                        <form class="wrapper" action="<?php echo e(url('/').'/shop'.'/'.Request::route('category').'/'.Request::route('subcategory')); ?>">
                              ...
                              <ul>
                                  <li>
                                      <div class="form-element has-icon">
                                          <form id="sortForm" action="<?php echo e(url('/').'/shop'.'/'.Request::route('category').'/'.Request::route('subcategory')); ?>">
