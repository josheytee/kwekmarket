...
<?php $__env->startSection('headertxt', 'Product Update'); ?>
...
<?php $__env->startPush('nicedit-scripts'); ?>
  ...
  <script type="text/javascript">
    bkLib.onDomLoaded(function() {
      new nicEditor({iconsPath : '<?php echo e(asset('assets/nic-edit/nicEditorIcons.gif')); ?>', fullPanel : true}).panelInstance('desc');
    });
  </script>
<?php $__env->stopPush(); ?>
              ...
              <div class="col-lg-12">
                  <div class="product-upload-inner"><!-- product upload inner -->
                      <form id="uploadForm" class="product-upload-form" onsubmit="upload(event)" enctype="multipart/form-data">
                          ...
                          <div class="row">
                            <div class="col-md-6">
                              <div class="form-element margin-bottom-20">
                                  ...
                                  <input name="title" type="text" class="input-field" value="<?php echo e($product->title); ?>" placeholder="Enter title...">
                              ...
                              <div class="row">
                                <div class="col-md-6">
                                  <div class="form-element margin-bottom-20">
                                      ...
                                      <input name="quantity" type="text" class="input-field" value="<?php echo e($product->quantity); ?>" placeholder="Enter quantity...">
                                      <p id="errquantity" class="em no-margin text-danger"></p>
                                  </div>
                                </div>
                                <div class="col-md-6">
                                  <div class="form-element margin-bottom-20">
                                      <label>Price (<?php echo e($gs->base_curr_text); ?>)<span>**</span></label>
                                      <input name="price" type="text" class="input-field" value="<?php echo e($product->price); ?>" placeholder="Enter price...">
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-4">
                              <div class="form-element margin-bottom-20">
                                  ...
                                  <input name="product_code" type="text" class="input-field" value="<?php echo e($product->product_code); ?>" placeholder="Enter product code...">
                          ...
                          <div id="proattrsid">
                            <?php if(array_key_exists('attributes', $attrs)): ?>
                              <?php $__currentLoopData = $attrs['attributes']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                ...
                                <?php endif; ?>
                                    <div class="col-md-4">
                                        <div class="form-element margin-bottom-20">
                                          <label>
                                            <?php if(str_contains($attrname, '_')): ?>
                                              <?php
                                              ...
                                              <?php $__currentLoopData = $pieces; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $piece): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <span style="text-transform: capitalize;color:black;"><?php echo e($piece); ?> </span>
                                              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            <?php else: ?>
                                              <span style="text-transform: capitalize;color:black;"><?php echo e($attrname); ?></span>
                                            <?php endif; ?>
                                            <span>**</span>
                                          </label>
                                          <?php
                                          ...
                                          <div>
                                              <?php $__currentLoopData = $options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                  <div class="form-check form-check-inline">
                                                    <input name="<?php echo e($attrname); ?>[]" value="<?php echo e($option->name); ?>" class="form-check-input" type="checkbox" id="attr<?php echo e($option->id); ?>"
                                                    <?php if(array_key_exists("$attrname", $checkedattrs)): ?>
                                                      <?php if(in_array($option->name, $checkedattrs["$attrname"])): ?>
                                                        checked
                                                      <?php endif; ?>
                                                    <?php endif; ?>
                                                      >
                                                    <label class="form-check-label" for="attr<?php echo e($option->id); ?>"><?php echo e($option->name); ?></label>
                                                  </div>
                                              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                          </div>
                                          <p class="em text-danger no-margin" id="err<?php echo e($attrname); ?>"></p>
                                        </div>
                                    </div>
                                <?php if($loop->iteration % 3 == 0 || count($attrs['attributes']) < 3): ?>
                                  </div>
                                <?php endif; ?>
                              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php endif; ?>
                          ...
                          <div class="form-element margin-bottom-20">
                             ...
                             <textarea class="form-control" id="desc" rows="10"><?php echo e($product->description); ?></textarea>
                                    ...
                                    <div class="col-md-4">
                                      <div class="form-element margin-bottom-20">
                                        ...
                                        <input data-toggle="toggle" data-onstyle="success" data-offstyle="danger"
                                           ...
                                           name="offer" onchange="changeOffer()" <?php echo e(!empty($product->offer_type) ? 'checked' : ''); ?>>
                                      </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                      <div class="form-element margin-bottom-20 d-none" id="offerType">
                                        ...
                                        <input data-toggle="toggle" data-onstyle="success" data-offstyle="danger"
                                           ...
                                           name="offer_type" id="offerTypeToggle" <?php echo e($product->offer_type == 'percent' ? 'checked' : ''); ?>>
                                      </div>
                                    </div>
                                    <div class="col-md-4">
                                      <div class="form-element margin-bottom-20 d-none" id="offerAmount">
                                        <label>Offer Amount <span>**</span></label>
                                        <input name="offer_amount" type="text" class="input-field" placeholder="Enter offer amount..." value="<?php echo e($product->offer_amount); ?>">
                                  ...
                                  <div class="row">
                                    <div class="col-md-2">
                                      <div class="form-element margin-bottom-20">
                                        ...
                                        <input data-toggle="toggle" data-onstyle="success" data-offstyle="danger"
                                           data-width="100%" type="checkbox"
                                           name="flash_sale" <?php echo e($product->flash_sale == 1 ? 'checked' : ''); ?>>
                                      </div>
                                    </div>
                                      ...
                                      <div class="row">
                                        <div class="col-md-3">
                                          <div class="form-element margin-bottom-20">
                                            ...
                                            <input data-toggle="toggle" data-onstyle="success" data-offstyle="danger"
                                               data-width="100%" type="checkbox" data-on="Percentage" data-off="Fixed"
                                               name="flash_type" <?php echo e($product->flash_type == 1 ? 'checked' : ''); ?>>
                                          </div>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                          <div class="form-element margin-bottom-20">
                                            ...
                                            <div class="form-check form-check-inline">
                                              <input class="input-field" type="text" name="flash_amount" value="<?php echo e($product->flash_amount); ?>" autocomplete="off" placeholder="Enter flash amount">
                                            </div>
                                        ...
                                        <div class="col-md-3">
                                          <div class="form-element margin-bottom-20">
                                            ...
                                            <div class="form-check form-check-inline">
                                              <input id="flash_date" class="input-field" type="text" name="flash_date" value="<?php echo e($product->flash_date); ?>" placeholder="Enter flash date" autocomplete="off">
                                            </div>
                                          ...
                                          <div class="form-element margin-bottom-20">
                                            ...
                                            <div class="form-check form-check-inline">
                                              <select class="input-field" name="flash_interval">
                                                <?php $__currentLoopData = $flashints; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $flashint): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                  <option value="<?php echo e($flashint->id); ?>" <?php echo e($flashint->id == $product->flash_interval ? 'selected' : ''); ?>><?php echo e($flashint->start_time . " - " . $flashint->end_time); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                              </select>
                                            </div>
                                          </div>
...
<?php $__env->startSection('preimgscripts'); ?>
  ...
  <script>
    var curr = '<?php echo e($gs->base_curr_text); ?>';
  ...
  <script>
    ...
    $(document).ready(function() {
      setTimeout(function() {
        $.get("<?php echo e(route('vendor.product.getimgs', $product->id)); ?>", function(data){
            for (var i = 0; i < data.length; i++) {
              imgsdb.push(data[i].image);
              $("#imgtable").append('<tr class="trdb" id="trdb'+i+'"><td><div class="thumbnail"><img style="width:150px;" src="<?php echo e(asset('assets/user/img/products')); ?>/'+data[i].image+'" alt="Ad Image"></div></td><td><button type="button" class="btn btn-danger pull-right rmvbtndb" onclick="rmvdbimg('+i+')"><i class="fa fa-times"></i></button></td></tr>');
            }
            console.log(imgsdb);
        });
      }, 2000);
    ...
    function upload(e) {
      ...
      swal({
        title: "Checking...",
        text: "Please wait",
        icon: "<?php echo e(asset('assets/user/img/ajax-loading.gif')); ?>",
        buttons: false,
      ...
      $.ajax({
        url: '<?php echo e(route('vendor.product.update')); ?>',
        type: 'POST',
        data: fd,
        contentType: false,
        processData: false,
